...
<div class="part_container fr-mb-6w">
  ...
  <ul>
    <li><code>default</code> : Couleur par défaut.</li>
    <li><code>neutral</code> : Palette neutre.</li>
    <li><code>categorical</code> : Palette catégorielle par défaut.</li>
    <li><code>sequentialAscending</code> : Palette séquentielle ascendante.</li>
    <li><code>sequentialDescending</code> : Palette séquentielle descendante.</li>
    <li><code>divergentAscending</code> : Palette divergente ascendante.</li>
    <li><code>divergentDescending</code> : Palette divergente descendante.</li>
  </ul>

  <h3>Graphiques unicolores</h3>
  <p>Une représentation graphique n'a pas toujours besoin d'être colorée. Lorsqu'il n'est pas nécessaire de différencier les formes par des couleurs, on affichera les graphes avec la couleur par défaut pour les graphes unicolores, avec l'option <code>default</code>.</p>
  <div class="fr-grid-row fr-grid-row--gutters">
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" color={colors['light']['dsfr-chart-colors-default']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-default']} /></div>
  </div>
  ...
  <div class="fr-grid-row fr-grid-row--gutters">
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" color={colors['light']['dsfr-chart-colors-neutral']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-neutral']} /></div>
  </div>
  ...
  <div class="fr-grid-row fr-grid-row--gutters">
    {#each [1,2,3,4,5,6,7,8] as i}
      <div class="fr-col-6 fr-col-md-4"><ColorCard title="Catégorie {i}" color={colors['light'][`dsfr-chart-colors-0${i}`]} /></div>
    {/each}
  </div>
  <hr class="fr-mt-6v">
  <div class="fr-grid-row fr-grid-row--gutters">
    {#each [1,2,3,4,5,6,7,8] as i}
      <div class="fr-col-6 fr-col-md-4"><ColorCard title="Catégorie {i}" isLightTheme={false} color={colors['dark'][`dsfr-chart-colors-0${i}`]} /></div>
    {/each}
  </div>
  ...
  <p>En fonction du nombre de catégories, on appliquera autant de valeurs de couleurs qu'il en existe dans un dégradé allant de la couleur de départ à la couleur d'arrivée.</p>
  <div class="fr-grid-row fr-grid-row--gutters">
    <div class="fr-col-6 fr-col-md-4"><ColorCard title="Catégorie 1" color={colors['light']['dsfr-chart-colors-09']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 2" color={colors['light']['dsfr-chart-colors-10']} /></div>
  </div>
  <hr class="fr-mt-6v">
  <div class="fr-grid-row fr-grid-row--gutters">
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-09']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 2" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-10']} /></div>
  </div>
  ...
  <div class="fr-grid-row fr-grid-row--gutters">
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" color={colors['light']['dsfr-chart-colors-11']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 2" color={colors['light']['dsfr-chart-colors-13']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 3" color={colors['light']['dsfr-chart-colors-15']} /></div>
  </div>
  <hr class="fr-mt-6v">
  <div class="fr-grid-row fr-grid-row--gutters">
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 1" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-11']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 2" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-13']} /></div>
    <div class="fr-col fr-col-md-4"><ColorCard title="Catégorie 3" isLightTheme={false} color={colors['dark']['dsfr-chart-colors-15']} /></div>
  </div>
</div>
