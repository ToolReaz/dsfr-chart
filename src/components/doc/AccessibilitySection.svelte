...
<div class="part_container fr-mb-10w">
  ...
  <div class="fr-mb-4v">
    <bar-chart
      x={chartData.barChart.unicolor.x}
      y={chartData.barChart.unicolor.y}
      name={chartData.barChart.unicolor.name}
      selected-palette={chartData.barChart.unicolor.selectedPalette}
    ></bar-chart>
  </div>
  ...
  <div class="fr-mb-4v">
    <gauge-chart
      value={chartData.gaugeChart.default.value}
      title={chartData.gaugeChart.default.title}
      description={chartData.gaugeChart.default.description}
    ></gauge-chart>
  </div>
  ...
  <p>
    ...
    <a href="https://www.systeme-de-design.gouv.fr/composants-et-modeles/composants/accordeon/" target="_blank">accordéon</a>
  ...
  <div>
    <table-chart
      x={chartData.tableChart.default.x}
      y={chartData.tableChart.default.y}
      name={chartData.tableChart.default.name}
      table-name={chartData.tableChart.default.tableName}
    ></table-chart>
  </div>
